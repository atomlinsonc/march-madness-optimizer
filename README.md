...
The current build is stdlib-only and uses a compact sample 2026-style dataset so it runs immediately without external dependencies.
...
- advancement and title odds from Monte Carlo simulation
...
- `data/sample_2026_bracket.json`: sample 16-team 2026-style field

## Notes

- The sample data is a working demo, not a scraped full 68-team bracket.
